...
*/
     ...
     */
    @Override
    public PageResult orderInquiry(Integer page, Integer pageSize, Integer status) {
        //分页
        ...
        Page<Orders> p = orderMapper.orderInquiry(ordersPageQueryDTO);

        List<OrderVO> list = new ArrayList<>();
        if (p != null && p.getTotal() > 0) {
            for (Orders orders1 : p) {
                Long orderid = orders1.getId();
                List<OrderDetail> OrderDetails = orderDetailMapper.orderInquiry(orderid);
    ...
    public OrderVO getorderDetail(Long id) {
        ...
        List<OrderDetail> OrderDetails = orderDetailMapper.orderInquiry(id);
        OrderVO orderVO = new OrderVO();
...
*/
    ...
    public PageResult conditionSearch(OrdersPageQueryDTO ordersPageQueryDTO) {
        ...
        Page<Orders> page = orderMapper.orderInquiry(ordersPageQueryDTO);
    ...
    private String getOrderDishesStr(Orders orders) {
        ...
        List<OrderDetail> orderDetailList = orderDetailMapper.orderInquiry(orders.getId());
    ...
    public OrderStatisticsVO statistics() {
        Integer toBeConfirmed = orderMapper.countStatus(null,Orders.TO_BE_CONFIRMED);
        Integer confirmed = orderMapper.countStatus(null,Orders.CONFIRMED);
        Integer deliveryInProgress = orderMapper.countStatus(null,Orders.DELIVERY_IN_PROGRESS);
